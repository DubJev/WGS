...
setup_file() {
    ...
    test_dir=$PWD
    test_dir_mod=$PWD/tests/ToolVersioning
...
@test "TestToolVersioning" {
    run $HOME/nextflow run $test_dir/modules/ToolVersioning/ToolVersioning.nf -c $test_dir/configs/ToolVersioning/ToolVersioning.config \
        --verInputs=$test_input --reportOutputs=$outdir
    assert_success
