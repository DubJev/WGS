...
@test "TestVEPModule" {
    run $HOME/nextflow run $test_dir/modules/VEP/VEP.nf -c $test_dir/configs/VEP/VEP.config --vpInputs=$test_input --verOutputs=$outdir --vpOutputs=$outdir
    [ "$status" -eq 0 ]
